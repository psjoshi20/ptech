...
"items":[
   {"update_timestamp":"2019-09-29T12:23:52+08:00",
    "timestamp":"2019-09-29T12:13:00+08:00",
    "valid_period":{"start":"2019-09-29T12:00:00+08:00",  "end":"2019-09-29T14:00:00+08:00"},
    "forecasts":[{"area":"Ang Mo Kio","forecast":"Partly Cloudy (Night)"},
                 {"area":"Bedok","forecast":"Partly Cloudy (Night)"},
                {"area":"Bishan","forecast":"Partly Cloudy (Night)"},
                {"area":"Boon Lay","forecast":"Partly Cloudy (Night)"},
                {"area":"Bukit Batok","forecast":"Partly Cloudy (Night)"},
                {"area":"Bukit Merah","forecast":"Partly Cloudy (Night)"},
                {"area":"Bukit Panjang","forecast":"Partly Cloudy (Night)"},
                {"area":"Bukit Timah","forecast":"Partly Cloudy (Night)"},
                {"area":"Central Water Catchment","forecast":"Partly Cloudy (Night)"},
                {"area":"Changi","forecast":"Partly Cloudy (Night)"},
                {"area":"Choa Chu Kang","forecast":"Partly Cloudy (Night)"},
                {"area":"Clementi","forecast":"Partly Cloudy (Night)"},
                {"area":"City","forecast":"Partly Cloudy (Night)"},
                {"area":"Geylang","forecast":"Partly Cloudy (Night)"},
                {"area":"Hougang","forecast":"Partly Cloudy (Night)"},
                {"area":"Jalan Bahar","forecast":"Partly Cloudy (Night)"},
                {"area":"Jurong East","forecast":"Partly Cloudy (Night)"},
                {"area":"Jurong Island","forecast":"Partly Cloudy (Night)"},
                {"area":"Jurong West","forecast":"Partly Cloudy (Night)"},
                {"area":"Kallang","forecast":"Partly Cloudy (Night)"},
                {"area":"Lim Chu Kang","forecast":"Partly Cloudy (Night)"},
                {"area":"Mandai","forecast":"Partly Cloudy (Night)"},
    {"area":"Marine Parade","forecast":"Partly Cloudy (Night)"},
    {"area":"Novena","forecast":"Partly Cloudy (Night)"},
    {"area":"Pasir Ris","forecast":"Partly Cloudy (Night)"},
    {"area":"Paya Lebar","forecast":"Partly Cloudy (Night)"},
    {"area":"Pioneer","forecast":"Partly Cloudy (Night)"},
    {"area":"Pulau Tekong","forecast":"Thundery Showers"},
    {"area":"Pulau Ubin","forecast":"Partly Cloudy (Night)"},
    {"area":"Punggol","forecast":"Partly Cloudy (Night)"},
    {"area":"Queenstown","forecast":"Partly Cloudy (Night)"},
    {"area":"Seletar","forecast":"Partly Cloudy (Night)"},
    {"area":"Sembawang","forecast":"Partly Cloudy (Night)"},
    {"area":"Sengkang","forecast":"Partly Cloudy (Night)"},
    {"area":"Sentosa","forecast":"Partly Cloudy (Night)"},
    {"area":"Serangoon","forecast":"Partly Cloudy (Night)"},
    {"area":"Southern Islands","forecast":"Partly Cloudy (Night)"},
    {"area":"Sungei Kadut","forecast":"Partly Cloudy (Night)"},
    {"area":"Tampines","forecast":"Partly Cloudy (Night)"},
    {"area":"Tanglin","forecast":"Partly Cloudy (Night)"},
    {"area":"Tengah","forecast":"Partly Cloudy (Night)"},
    {"area":"Toa Payoh","forecast":"Partly Cloudy (Night)"},
    {"area":"Tuas","forecast":"Showers"},
    {"area":"Western Islands","forecast":"Partly Cloudy (Night)"},
    {"area":"Western Water Catchment","forecast":"Partly Cloudy (Night)"},
    {"area":"Woodlands","forecast":"Partly Cloudy (Night)"},
    {"area":"Yishun","forecast":"Partly Cloudy (Night)"}]}],
...
export const useWeather = (xx1) => {
    ...
    if( ! weath ) { fetch("https://api.data.gov.sg/v1/environment/2-hour-weather-forecast")
                       .then(a1 => a1.json())
                       .then(a1 => {console.log("Got data - " + a1); setWeath(a1)}); }
    return weath;
}
